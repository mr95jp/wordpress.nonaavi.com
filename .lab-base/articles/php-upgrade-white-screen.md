---
title: "WordPressが真っ白になった時の対処法 — 原因の見分け方と直し方"
slug: php-upgrade-white-screen
seo_title: "WordPress 真っ白・白い画面の対処法｜原因と直し方"
description: "WordPressの画面が真っ白（白い画面・ホワイトスクリーン）になった時の対処法。PHPアップデートやプラグインが原因のケースを、まず試すことから順に解説。display_errorsとエラーハンドラの設定で見え方が4通りに変わることを実測。"
keywords: "WordPress 真っ白, 白い画面, ホワイトスクリーン, 画面 真っ白 対処, WordPress 白画面 直し方, PHP バージョン 白画面, WSOD"
category: 障害報告
